...
ExistProt <- aggregate(ExistProt, fact =3)
...
scenario_name <- "3km_SACSPA_UNWcost_LA2" #Each scenario needs a unique name
scenario_group <- "ExistingProtectionIn"
...
feat_stack_3km <- addLayer(feat_stack_3km, ExistProt) # Jamie changed this from fea_stack_1km
...
# Export the summary to CSV
write.csv(sum_df, file=paste0(scenario_name, "_solution_comparisons_3km.csv"))
