...
scenario_name <- "1km_initial_STDcost_LA" #Each scenario needs a unique name
...
penalty <- round(seq(prelim_penalty[5], prelim_penalty[7], length.out = 9), 5)
...
best_soln_index
best_solution <- solution_layers[[best_soln_index]]  # Can change manually - just replace best_soln_index with a number# best_solution <- solution_layers[[4]]
