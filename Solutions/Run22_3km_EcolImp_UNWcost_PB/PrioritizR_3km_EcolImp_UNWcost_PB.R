...
scenario_name <- "3km_EcolImp_UNWcost_PB" #Each scenario needs a unique name
scenario_group <- "EcolImp"
...
penalty <- round(seq(prelim_penalty[8], prelim_penalty[9], length.out = 9), 5)
penalty
