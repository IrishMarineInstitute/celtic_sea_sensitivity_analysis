...
scenario_name <- "3km_pragmatic_UNWcost_PB" #Each scenario needs a unique name
...
cost <- cost_stack_3km[[6]] # Choose cost layer
...
penalty <- round(seq(prelim_penalty[7], prelim_penalty[8], length.out = 9), 5)
penalty
